...
import com.libriflow.book.controller.error.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleBookNotFound(BookNotFoundException exception, HttpServletRequest request) {
        return build(HttpStatus.NOT_FOUND, "BOOK_NOT_FOUND", exception.getMessage(), request.getRequestURI(), List.of());
    }

    @ExceptionHandler(BookAlreadyExistsException.class)
    public ResponseEntity<ApiErrorResponse> handleBookAlreadyExists(BookAlreadyExistsException exception, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, "BOOK_ALREADY_EXISTS", exception.getMessage(), request.getRequestURI(), List.of());
    }
